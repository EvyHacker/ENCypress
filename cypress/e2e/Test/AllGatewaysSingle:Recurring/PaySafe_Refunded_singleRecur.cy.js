...
const donationSingle = ('en_paysafe_refunded_single_' + todaysDate + '@engagingnetworks.online')
const donationRecur = ('en_paysafe_refunded_recur_' + tomorrowsDate + '@engagingnetworks.online')
...
describe('test partial refund for Paysafe gateway for Single and Recurring transactions', () => {



  beforeEach(() => {
    cy.visit(Cypress.env('test') + 'page/14801/donate/1')
  })
