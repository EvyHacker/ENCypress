...
describe('test partial refund for Payflow gateway for Single and Recurring transactions', () => {
  ...
  const donationSingle = ('en_payflow_refunded_single_' + todaysDate + '@engagingnetworks.online')
  const donationRecur = ('en_payflow_refunded_recur_' + tomorrowsDate + '@engagingnetworks.online')
