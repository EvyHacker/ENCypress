...
describe('test partial refund for Stripe gateway 3D and none 3D transactions', () => {
  ...
  const donationRecurSepaAnnual = ('en_stripe_sepa_recur_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurSepa = ('en_stripe_sepa_recur_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurCC3220Annual = ('en_stripe_recur_cc3220_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurCC3220 = ('en_stripe_recur_cc3220_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurCC4444Annual = ('en_stripe_recur_cc4444_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurCC4444 = ('en_stripe_recur_cc4444_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurCC4242Annual = ('en_stripe_recur_cc4242_refunded_' + tomorrowsDate + '@engagingnetworks.online')
  const donationRecurCC4242 = ('en_stripe_recur_cc4242_refunded_' + tomorrowsDate + '@engagingnetworks.online')
